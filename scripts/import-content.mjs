...
const plantSchema = z.object({
  ...
  traditional_use_summary: z.string(),
  age_restrictions: z.array(z.string()),
  max_duration_dose: z.array(z.string()),
  toxicity_signals: z.array(z.string()),
  hard_caution: z.boolean(),
  contraindications: z.array(z.string()),
  interactions: z.array(
    z.object({
      drug_or_class: z.string(),
      mechanism: z.string(),
      severity: z.enum(["AVOID", "MAJOR", "MODERATE", "MINOR_THEORETICAL"]),
    }),
  ),
