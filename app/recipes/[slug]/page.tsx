...
export default async function RecipeDetailPage({
  ...
  const plants = recipe.components.map((component) => component.plant).filter(
    (plant): plant is NonNullable<typeof plant> => Boolean(plant),
  );
    ...
    <AppShell title="Virtual Apothecary" navIndex={2}>
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-4 px-4 py-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <PlantSafetyCard plants={plants} recipeNotes={recipe.safety_notes} />
